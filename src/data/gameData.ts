...
const gameData: gameData[] = // 20220306212333
...
export const getGamesData = () => gameData;

export const getGameData = (id: number) => gameData.find(m => m.id === id);